...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="about-team pt-100 pt-sm-60">
            <div class="container">
               <h3 class="mb-30 about-title">our team</h3>
                <div class="row text-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                        <div class="single-team mb-xxs-30">
                            <div class="team-img sidebar-img">
                                <img src="img\team\tien.jpeg" alt="team-image">
                                <div class="team-link">
                                    <ul>
                                        <li><a href="https://www.facebook.com/profile.php?id=100015608857056"><i class="fa fa-facebook">Facebook</i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="team-info">
                                <h4>Nguyen Trong Vinh Tien</h4>
                                <p>Web Developer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                        <div class="single-team">
                            <div class="team-img sidebar-img">
                                <img src="img\team\anh.jpg" alt="team-image">
                                <div class="team-link">
                                    <ul>
                                        <li><a href="https://www.facebook.com/ngocanhh1501"><i class="fa fa-facebook">Facebook</i></a></li>
                                        
                                    </ul>
                                </div>
                            </div>
                            <div class="team-info">
                                <h4>Nguyen Thi Ngoc Anh</h4>
                                <p>Web Developer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                       <h3 class="about-title mb-20">Our skills</h3>
                        <div class="skill-progress mb-all-40">
                            ...
                            <div class="progress">
                                <div class="skill-title">HTML 20%</div>
                            ...
                            <div class="progress">
                                <div class="skill-title">CSS 30%</div>
                            ...
                            <div class="progress">
                                <div class="skill-title">JavaScript 20%</div>
                            ...
                            <div class="progress">
                                <div class="skill-title">MySQL 30%</div>
                        ...
                        <div class="ht-single-about">
                            ...
                            <div class="ht-about-work">
                                ...
                                <div class="ht-work-text">
                                    <h5><a href="#">Using Theme</a></h5>
                                    <p>Using free Emcommerce website thme</p>
                                </div>
                            </div>
                            <div class="ht-about-work">
                                <span>2</span>
                                <div class="ht-work-text">
                                    <h5><a href="#">Using HTML CSS JavaScript</a></h5>
                                    <p>Using these component to re build this website</p>
                                </div>
                            </div>
                            <div class="ht-about-work">
                                <span>3</span>
                                <div class="ht-work-text">
                                    <h5><a href="#">Database mysql</a></h5>
                                    <p>With MySQL we build this website to test all function on localhost</p>
                                </div>
                            </div>
